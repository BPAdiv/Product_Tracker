...
var context = {};
var checkIfUserConnected = function (telegramId) {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            users_1.default.findOne({ telegramId: telegramId.toString() }),
          ];
        case 2:
          user = _a.sent();
...
var activateBot = function () {
  ...
  var handleAddingNewProductState = function (chatId, text, userId) {
    return __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, function (_f) {
        switch (_f.label) {
          ...
          case 2:
            ...
            proLink =
              (_b = context[chatId].verifyProduct) === null || _b === void 0
                ? void 0
                : _b.productLink;
            context[chatId].verifyProduct = {
          ...
          case 3:
            ...
            return [
              ...
              axios_1.default.post(
                ...
                {
                  targetPrice:
                    (_c = context[chatId].verifyProduct) === null ||
                    _c === void 0
                      ? void 0
                      : _c.targetPrice,
                  productLink:
                    (_d = context[chatId].verifyProduct) === null ||
                    _d === void 0
                      ? void 0
                      : _d.productLink,
                }
          ...
          case 4:
            ...
            data_1.productLink =
              (_e = context[chatId].verifyProduct) === null || _e === void 0
                ? void 0
                : _e.productLink;
  ...
  var handleRemovingProductsState = function (chatId, text, userId) {
    return __awaiter(void 0, void 0, void 0, function () {
      var data_2, error_3;
      return __generator(this, function (_a) {
        switch (_a.label) {
  ...
  var handleLogininState = function (chatId, text, userId) {
    return __awaiter(void 0, void 0, void 0, function () {
      var data_3, error_4;
      return __generator(this, function (_a) {
        switch (_a.label) {
  ...
  var handleSignupState = function (chatId, text, userId) {
    return __awaiter(void 0, void 0, void 0, function () {
      var data_4, error_5;
      return __generator(this, function (_a) {
        switch (_a.label) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            bot.sendMessage(
              message.chat.id,
              "You clicked the ".concat(data, " button")
            );
            if (
              !(
                data === "login" && context[message.chat.id].state === "userNot"
              )
            )
              return [3 /*break*/, 1];
          ...
          case 2:
            ...
            return [
              2 /*return*/,
              bot.sendMessage(message.chat.id, "Ok Not Confirmed"),
            ];
          case 3:
            if (
              !(
  ...
  bot.onText(/\/newtrack/, function (msg) {
    return __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            chatId = msg.chat.id;
            if (context[chatId]) return [2 /*return*/];
        ...
        switch (_a.label) {
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              axios_1.default.get(
                "${process.env.VITE_BACKEND_URL}/api/product/user/".concat(
                  userChecked._id
                )
              ),
            ];
          case 3:
            ...
            data_6.products.forEach(function (pro) {
              if (!pro.image) return;
              var formatLastUpdated =
                pro.lastUpdated &&
                (0, timeago_js_1.format)(
                  new Date(
                    pro === null || pro === void 0 ? void 0 : pro.lastUpdated
                  )
                );
              bot.sendPhoto(chatId, pro.image, {
                caption: ""
                  .concat(pro.title, " \n \nThe current price is : <b>")
                  .concat(pro.currentPrice, "</b>\n \n<div>")
                  .concat(
                    pro.lastUpdated &&
                      "Last updated: ".concat(formatLastUpdated),
                    "</div>\n              "
                  ),
                parse_mode: "HTML",
                reply_markup: {
                  inline_keyboard: [
                    [
                      {
                        text: "Amazon Link",
                        url: exports.globalLink + pro.productAsin,
                      },
                    ],
                  ],
                },
  ...
  bot.sendPhoto(telegramId, targetProduct.image, {
    caption:
      ...
      ""
        ...
        .concat(exports.globalLink + targetProduct.productAsin, '">')
        .concat(
          exports.globalLink + targetProduct.productAsin,
          "</a> \n\nYour chat Id is "
        )
